...
public class OtpService {
    ...
    public String generateOtp(String phoneNumber) {
        ...
        cacheOtp(phoneNumber, otp);  // Caching the OTP
        return "OTP generated successfully. OTP is: " + otp;
    }

    // Cache OTP in Redis (using @Cacheable)
    ...
    // Validate OTP and return meaningful message (using @CacheEvict to clear OTP after validation)
    @CacheEvict(value = "otpCache", key = "#phoneNumber")
